...
SOURCE_FILES = [
    ...
    ASSISTANT_DIR / "skills" / "total-rainfall" / "SKILL.md",
    ASSISTANT_DIR / "skills" / "consecutive-dry-days" / "SKILL.md",
    ASSISTANT_DIR / "skills" / "heavy-rainfall" / "SKILL.md",
    ASSISTANT_DIR / "skills" / "mean-temperature" / "SKILL.md",
    ASSISTANT_DIR / "skills" / "min-max-temperature" / "SKILL.md",
    ASSISTANT_DIR / "skills" / "hot-cold-days" / "SKILL.md",
    ...
    ASSISTANT_DIR / "skills" / "regional-rainfall" / "SKILL.md",
    ASSISTANT_DIR / "skills" / "regional-temperature" / "SKILL.md",
