...
SOURCE_FILES = [
    ...
    ASSISTANT_DIR / "skills" / "total_rainfall.md",
    ASSISTANT_DIR / "skills" / "consecutive_dry_days.md",
    ASSISTANT_DIR / "skills" / "heavy_rainfall.md",
    ASSISTANT_DIR / "skills" / "mean_temperature.md",
    ASSISTANT_DIR / "skills" / "min_max_temperature.md",
    ASSISTANT_DIR / "skills" / "hot_cold_days.md",
    ASSISTANT_DIR / "skills" / "sea_level_site_setup.md",
    ...
    ASSISTANT_DIR / "skills" / "regional_setup.md",
    ASSISTANT_DIR / "skills" / "regional_rainfall.md",
    ASSISTANT_DIR / "skills" / "regional_temperature.md",
    ASSISTANT_DIR / "skills" / "regional_sea_level.md",
